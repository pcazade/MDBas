...
void ocl_get_platform()
{
    ...
    if (errCode == CL_SUCCESS) ;
        ...
        fprintf(ocl_info,"Error when obtaining platforms : error code : %d\n",errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform name is : %s\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform name  : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform vendor is : %s\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform vendor  : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform version is  : %s\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform version : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform profile is  : %s\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform profile : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform extensions are  : %s\n\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform extensions  : error code %d\n", errCode);
    }
...
void ocl_get_device()
{
    ...
    if (errCode == CL_SUCCESS) ;
        ...
        fprintf(ocl_info,"Error when obtaining devices for Platform : error code : %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform Device name is : %s\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform Device name : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform Device vendor is : %s\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform Device vendor : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform Device global memory is (MB) : %lf\n", mem_info/TO_MB) ;
        ...
        fprintf(ocl_info,"Error for Platform Device global memory : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform Device max alloc memory is (MB) : %lf\n", mem_info/TO_MB) ;
        ...
        fprintf(ocl_info,"Error for Platform Device max alloc memory : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform Device constant memory is (KB) : %lf\n", mem_info/TO_KB) ;
        ...
        fprintf(ocl_info,"Error for Platform Device constant memory  : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform Device local memory is (KB) : %lf\n", mem_info/TO_KB) ;
        ...
        fprintf(ocl_info,"Error for Platform Device local memory  : error code %d\n", errCode);
    }
    ...
    if (errCode == CL_SUCCESS) fprintf(ocl_info,"Platform Device extensions are : %s\n\n", buff) ;
        ...
        fprintf(ocl_info,"Error for Platform Device extensions  : error code %d\n", errCode);
    }
...
void ocl_get_context()
{
    ...
    if (errCode == CL_SUCCESS) ;
        ...
        fprintf(ocl_info,"Error when adding a device to context : error code : %d\n", errCode);
    }
}
...
void ocl_get_cmdQueue()
{
    ...
    if (errCode == CL_SUCCESS) ;
        ...
        fprintf(ocl_info,"Error when creating command queue : error code : %d\n", errCode);
    }
